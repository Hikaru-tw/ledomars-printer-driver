...
========================================================================================
 ...
 ------|---WIN2000(XP-Vista-Win7)
             (contains Windows 2000 ,Windows XP ,Vista ,Windows 7 driver installation files)
       |---WIN8(WIN10)
             (contains Windows 8 ,Windows 10 driver installation files)

The steps of installing the driver in the Windows 2000 or the Windows XP,Windows vista,Windows7,Windows8,Windows10:
========================================================================================
...
2.use the "Add the printer" wizard:
	...
	5. Come out a window of "Install From Disk". Please according to the operating system
	   environment, you should select the path as follow: CD-ROM-"Driver"-"WIN2000"(XP-Vista-Win7)", 
