...
========================================================================================
 ...
 ------|---WIN10(WIN8)
             (contains Windows 8 and Windows 10 driver installation files)
       |---WIN7(XP-Vista-Win2000)
...
2.use the "Add the printer" wizard:
	...
	5. Come out a window of "Install From Disk". Please according to the operating system
	   environment, you should select the path as follow: CD-ROM-"Drivers"-"WIN2000(XP-Vista-Win7)"/"Windows8", 
	   where you can find a file named: *.inf, click "Open", then click "OK"
...
2.The installing steps of USB driver in Windows 98 or Windows Me:
	...
	3) Come out a window of "Add New Hardware Wizard", 
           choose "Search for the best driver for your device (recommended)", click "Next". 
	 
	4) Come out a window of "Add New Hardware Wizard", check "Specify a location", 
           click "Browse" , select the path as follows:
 	   CD-ROM-"Drivers\WIN98(WINME)\USBdriver", then click "OK". 
	 
	5) Return to the window of "Add New Hardware Wizard", click "Next"; 
